...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            ...
            <h1 class="mb-1 font-medium">Real-Time Orders</h1>
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">This is a test project built with <strong>Laravel
                    Reverb, Laravel Pulse</strong> and <strong>Laravel Forge</strong>, showcasing real-time order management using the
                power of the Laravel ecosystem.</p>
            <ul class="flex flex-col mb-4 lg:mb-6">
                <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                    ...
                    <span>
                                Built by
                                <a href="https://molxno.dev/" target="_blank"
                ...
                <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                    ...
                    <span>
                                ...
                                <a href="https://www.linkedin.com/in/molanosantiago/" target="_blank"
                                   class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ms-1">
                                    <span>LinkedIn</span>
                                    <svg
                                        width="10"
            ...
            <ul class="flex gap-3 text-sm leading-normal">
                <li>
                    <a href="https://github.com/molxno/real-time-orders" target="_blank"
        ...
        <div
            ...
            >
                <!-- Sombrero -->
                <path d="M32 6L22 30H42L32 6Z" fill="#010606"/>
                <ellipse cx="32" cy="32" rx="14" ry="4" fill="#D9DCD9"/>
                <rect x="18" y="32" width="28" height="4" rx="2" fill="#010606"/>

                <!-- Varita -->
                <rect x="10" y="45" width="2" height="20" transform="rotate(-45 10 45)" fill="#D9DCD9"/>
                <circle cx="8" cy="43" r="1.5" fill="#DF2935"/>
                <circle cx="15" cy="50" r="1" fill="#DF2935"/>
                <circle cx="5" cy="48" r="1" fill="#DF2935"/>
                <circle cx="12" cy="41" r="0.8" fill="#DF2935"/>

                <!-- Sparkles -->
                <polygon points="52,12 54,16 58,16 55,19 56,23 52,21 48,23 49,19 46,16 50,16"
                         fill="#DF2935"/>
                <circle cx="48" cy="10" r="1.2" fill="#DF2935"/>
                <circle cx="56" cy="8" r="1.5" fill="#DF2935"/>
            </svg>
...
<div class="fixed bottom-0 right-0 p-4 text-xs text-gray-500 opacity-70 dark:text-white">
    © molxno, Property of a Backend Wizard.<br>
    Made with ❤️
</div>
</body>
</html>
